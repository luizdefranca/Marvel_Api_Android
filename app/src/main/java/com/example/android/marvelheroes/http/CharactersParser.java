...
public class CharactersParser {
    ...
    public static final String URL_SEARCH_BY_ID = "https://gateway.marvel.com:443/v1/public/characters/%s?ts=12321&apikey=4ba91b7387292017df2ef6d0f93e78b3&hash=ed64bda8bdd12e45f51a6f7f1be5be98";
    ...
    public static Character searchById(String id) throws IOException {
        OkHttpClient client = new OkHttpClient();

        Request request = new Request.Builder()
                .url(String.format(URL_SEARCH_BY_ID, id))
                .build();
        ...
        if (response.networkResponse().code() == HttpURLConnection.HTTP_OK) {
            ...
            //verifica se nao retornou uma JSON nula
            if(result != null){
                return result.data.charactersList.get(0);
            }
        }
